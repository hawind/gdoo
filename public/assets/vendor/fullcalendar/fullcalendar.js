...
function Header(calendar) {
					...
					if (buttonName == 'title') {
						...
						if (buttonClick) {
							...
							if (overrideText) {
								...
								innerHtml = "<span class='icon " + normalIcon + "'></span>";
							}
							else {
							...
							button = $( // type="button" so that it doesn't submit a form
								...
								.mousedown(function() {
									...
									button
										...
										.addClass(tm + '-state-down active');
								})
								.mouseup(function() {
									// undo the *down* effect
									button.removeClass(tm + '-state-down active');
								})
								.hover(
									function() {
										// the *hover* effect.
	...
	function activateButton(buttonName) {
		if (el) {
			el.find('.fc-' + buttonName + '-button')
				.addClass(tm + '-state-active active');
		}
	}
	...
	function deactivateButton(buttonName) {
		if (el) {
			el.find('.fc-' + buttonName + '-button')
				.removeClass(tm + '-state-active active');
		}
	}
	...
	function disableButton(buttonName) {
		if (el) {
			el.find('.fc-' + buttonName + '-button')
				.prop('disabled', true)
				.addClass(tm + '-state-disabled disabled');
		}
	}
	...
	function enableButton(buttonName) {
		if (el) {
			el.find('.fc-' + buttonName + '-button')
				.prop('disabled', false)
				.removeClass(tm + '-state-disabled disabled');
		}
	}
