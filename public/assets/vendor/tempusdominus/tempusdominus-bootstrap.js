    ...
    var TempusDominusBootstrap3 = function (_DateTimePicker) {
        ...
        TempusDominusBootstrap3.prototype._fillDate = function _fillDate() {
            ...
            for (i = 0; i < 42; i++) {
                ...
                // 加入渲染回调函数
                var currentDay = currentDate.format('L');
                if (typeof this._options.onSelectDay === 'function') {
                    clsName = this._options.onSelectDay(clsName, currentDay);
                }

                row.append('<td data-action="selectDay" data-day="' + currentDay + '" class="day' + clsName + '"><span>' + currentDate.date() + '</span></td>');
                currentDate.add(1, 'd');
            }
