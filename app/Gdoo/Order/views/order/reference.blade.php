...
(function($) {
    ...
    sGrid.columnDefs = [
        ...
        {cellClass:'text-center', field: 'current_stock', headerName: '现存量', width: 80},
        {cellClass:'text-right', field: 'total_quantity', headerName: '订单数量', width: 80},
        {cellClass:'text-right', field: 'use_quantity', headerName: '已发数量', width: 80},
        {cellClass:'text-right', field: 'quantity', headerName: '未发数量', width: 80},
        {cellClass:'text-center', field: 'id', headerName: 'ID', width: 60}
    ];
