<style>
    ...
    (function($) {
        ...
        sGrid.columnDefs = [
            ...
            {cellClass:'text-right', field: 'num', type:'number', headerName: '订单数量', width: 80},
            {cellClass:'text-right', field: 'yf_num',type:'number', headerName: '已发数量', width: 80},
            {cellClass:'text-right', field: 'wf_num', type:'number', headerName: '未发数量', width: 80},
            {cellClass:'text-center', field: 'id', headerName: 'ID', width: 60}
        ];
