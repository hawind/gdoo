...
<div class="form-panel" id="tab-content-product_formula">
...
(function($) {
    ...
    options.columns = [
        ...
        {suppressNavigable: false, type:'number', cellClass:"text-right",headerName:"用量",editable:true,width:80,field:"quantity"},
        {suppressNavigable: false, type:'number', cellClass:"text-right",headerName:"出品率",editable:true,width:80,field:"ratio"},
    ];
    options.links = {
        product_id: {
            product_id:'id',
